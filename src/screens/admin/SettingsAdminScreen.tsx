// src/screens/admin/SettingsAdminScreen.tsx

import { changePasswordAction, updateProfileAction } from '@/app/admin/settings/actions';
...
export default function SettingsAdminScreen({ user }: SettingsAdminProps) {
  return (
